...
import type { ApplicationStatus as _ApplicationStatus, BorrowerProfile as _BorrowerProfile, LoanApplication as _LoanApplication, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getApplicationsByBorrower(arg0: string): Promise<Array<LoanApplication>> {
        if (this.processError) {
            try {
                const result = await this.actor.getApplicationsByBorrower(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBorrowerByPrincipal(arg0: Principal): Promise<BorrowerProfile | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getBorrowerByPrincipal(arg0);
    ...
    async getLoanProducts(): Promise<Array<LoanProduct>> {
        if (this.processError) {
            try {
    ...
    async registerBorrower(arg0: string, arg1: BorrowerProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerBorrower(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitApplication(arg0: LoanApplication): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitApplication(to_candid_LoanApplication_n21(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateApplicationStatus(arg0: string, arg1: ApplicationStatus, arg2: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateApplicationStatus(arg0, to_candid_ApplicationStatus_n23(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n25(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_LoanApplication_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _LoanApplication): LoanApplication {
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BorrowerProfile]): BorrowerProfile | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        productId: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.productId)),
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? ApplicationStatus.pending : "disbursed" in value ? ApplicationStatus.disbursed : "approved" in value ? ApplicationStatus.approved : "rejected" in value ? ApplicationStatus.rejected : "under_review" in value ? ApplicationStatus.under_review : value;
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_LoanApplication>): Array<LoanApplication> {
    return value.map((x)=>from_candid_LoanApplication_n11(_uploadFile, _downloadFile, x));
}
...
function to_candid_LoanApplication_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: LoanApplication): _LoanApplication {
...
function to_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: to_candid_ApplicationStatus_n23(_uploadFile, _downloadFile, value.status),
        borrowerId: value.borrowerId,
        submittedAt: value.submittedAt,
